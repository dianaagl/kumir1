...
class CustomWindowPrivate : public QObject
{
public:
	void init(
...
public:
	...
	bool isHovered() const { return b_hovered; }
	bool isPressed() const { return b_pressed; }
