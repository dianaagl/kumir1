    ...
    ui(new Ui::Robot25DWindow)
{
    ...
    const QString resPath = QApplication::applicationDirPath()+"/Addons/robot25d/resources/";
...
//    QBrush bgBrush = QBrush(bgImg);
    ...
    loadGame(QApplication::applicationDirPath()+"/Addons/robot25d/resources/default.pm.json");
