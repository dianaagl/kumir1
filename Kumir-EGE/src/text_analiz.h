...
public:
    ...
    void analizeModule(int module_id);
    ...
    QString generateJavaCodeForExpression(const QStringList &exprList,
    ...
    int parceVariablesDeclaration(proga &pv,int str,QString alg,symbol_table *symbols,function_table *table,QString *xml);
    int parceAssignment(proga &pv,function_table *table,symbol_table *symbols,int str, QString *root);
    //	int new_parce_prisv(QString prisv,function_table *table,symbol_table *symbols,int str,int *err_start,int *err_end);
    int parseLoopBegin(proga &pv,symbol_table *symbols,function_table *functions,int str, QString *xml);
    int parce_if(proga &pv,symbol_table *symbols,
                 function_table *functions,int str,QString *xml);
    int parceOutput(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);
    int parce_fvivod(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);
    int parce_utv(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);

    int parce_kc_pri(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);

    int parce_dano(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);
    int parce_nado(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);

    int parceInput(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);

    int parce_fvvod(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);

    int parce_vibor(QString utv,function_table *table,symbol_table *symbols,int str);
    int parce_pri(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);
    ...
    int parce_doc(QString instr,function_table *functions,symbol_table *symbols,int str,QString *xml);
...
private:
    ...
    void generateEntryPoint(const QStringList &argGroups,
                            ...
                            RealLine realLine);
    int parceAlgorhitmCall(proga &pv,function_table *table,symbol_table *symbols,int str,QString *xml);
